function validate_password() {
    ...
    while true; do
        ...
        if [[ ${#walletpassword} -ge 8 && "$walletpassword" == *[A-Z]* && "$walletpassword" == *[a-z]* && "$walletpassword" == *[0-9]* ]]; then
  		...
  		docker run -d -it -v /home/"$username"/Eth2Validators/prysm-wallet-v2:/wallet -v /home/"$username"/Eth2:/validatorDB --network="host" --name validator gcr.io/prysmaticlabs/prysm/validator:v5.0.2 --beacon-rpc-provider=95.179.226.159:4000 --holesky  --wallet-dir=/wallet --datadir=/validatorDB --suggested-fee-recipient="$walletaddress"
